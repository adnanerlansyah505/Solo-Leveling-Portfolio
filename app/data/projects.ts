export const projects = [
  {
    id: 1,
    name: 'Namina Batik',
    description: 'A modern online store for authentic Batik crafts, complete with product browsing and responsive UI.',
  ...
  {
    id: 2,
    name: 'Surau Darul Hikmah Portal',
    description: 'A community portal for prayer schedules, announcements, and worship center management.',
    tech: ['AstroJS',  'TailwindCSS'],
    status: 'Completed',
  ...
  {
    id: 3,
    name: 'Library Seats Booking',
    description: 'A library seat reservation system that streamlines user bookings and seat availability.',
  ...
  {
    id: 4,
    name: 'Online Student Registration System',
    description: 'A comprehensive student enrollment system with registration workflows and administrative dashboards.',
    tech: ['NuxtJS', 'Drizzle ORM', 'PostgreSQL', 'TailwindCSS'],
    status: 'Completed',
